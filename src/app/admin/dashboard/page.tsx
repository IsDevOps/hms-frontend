...
//   const [selectedAnomalyRoom, setSelectedAnomalyRoom] = useState<string | null>(null);
...
//             <button
//                   key={room.id}
//                   onClick={() => handleRoomClick(room.number, !!room.hasAnomaly)}
//                   className={cn(
//                     "p-2 rounded-lg border text-center transition-all duration-200 hover:scale-105",
//                     room.hasAnomaly
...
//                     room.hasAnomaly ? "bg-destructive" : statusColors[room.status]
//                   )} />
//                   <p className="text-xs font-medium text-foreground">{room.number}</p>
//                   {room.guestName && (
...
const AdminDashboard = () => {
  ...
  // Listen for food orders and service requests
  useEffect(() => {
              ...
              {MOCK_ROOMS.map((room) => (
                <button
                  ...
                  className={cn(
                    ...
                    room.hasAnomaly
                      ? 'border-destructive bg-destructive/10 animate-pulse-soft cursor-pointer'
                      : 'border-border bg-card cursor-default'
                  )}
                >
                  <div
